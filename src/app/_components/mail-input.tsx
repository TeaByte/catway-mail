...
export default function MailInput({
  ...
  return (
    <>
      <div className="relative flex w-full flex-col items-start border border-white/[0.2] bg-background p-4 lg:w-1/2 ">
      ...
      {description && (
        <div className=":w-1/2 flex flex-col items-center justify-center gap-1 text-sm">
